...
/* #define AUDI104_USE_BITS_SIGNAL */
...
/* #define AUDI104_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (AUDI104_USE_DIAG_MONITORS) and define below
